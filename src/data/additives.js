...
export const ADDITIVES = [
  ...
  // ===== Ionophore =====
  { id: 'monensin_rumensin',     name: 'Monensin (Rumensin)',              brand: 'Elanco',         category: 'Ionophore', typicalDose: 1.5, doseRange: '0.8–2.5 g/hd/d (300–450 mg monensin)', price: 22.00, note: '+2–6% feed efficiency. Shifts rumen VFA toward propionate, reduces methane.', species: ['Dairy','Beef'], stages: 'all', regulatoryNote: 'Banned for dairy in EU. Check local regulations.' },
  { id: 'lasalocid_bovatec',     name: 'Lasalocid (Bovatec)',              brand: 'Zoetis',         category: 'Ionophore', typicalDose: 1.2, doseRange: '0.6–2.0 g/hd/d', price: 20.00, note: 'Alternative to monensin. Broader antimicrobial spectrum.', species: ['Beef'], stages: ['Growing / Stocker','Backgrounding','Finishing'] },
  { id: 'salinomycin',           name: 'Salinomycin',                      brand: 'Generic',        category: 'Ionophore', typicalDose: 1.0, doseRange: '0.4–1.5 g/hd/d', price: 18.00, note: 'Beef feedlot ionophore. Cost-effective alternative in some markets.', species: ['Beef'], stages: ['Backgrounding','Finishing'] },
